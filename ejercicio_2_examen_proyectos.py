...
while True:
 ...
 if opcion == 1:
            ...
            cursor.execute("INSERT INTO ejercicio_examen_2(nota_1,nota_2,nota_3,nota_4,nota_5,media,mediana,desviacion_estandar,varianza,rango,moda) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);",(n1,n2,n3,n4,n5,media,mediana,desviacion_estandar,varianza,rango,moda))
            conexion.commit()
            cursor.close() 
            ...
            cursor = conexion.cursor()
            SQL = 'SELECT*FROM ejercicio_examen_2;'
            cursor.execute(SQL)
